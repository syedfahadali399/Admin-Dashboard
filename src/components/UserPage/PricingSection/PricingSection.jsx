...
<div className="max-w-[85rem] px-4 py-10 sm:px-6 lg:px-8 lg:py-14 mx-auto">
  ...
  <div className="flex justify-center items-center gap-x-3">
    <label htmlFor="pricing-switch" className="text-sm text-gray-800 dark:text-neutral-200">Monthly</label>
    <label htmlFor="pricing-switch" className="relative inline-block w-11 h-6 cursor-pointer">
      <input type="checkbox" id="pricing-switch" className="peer sr-only"/>
      ...
      <span className="absolute top-1/2 start-0.5 -translate-y-1/2 size-5 bg-white rounded-full shadow-xs transition-transhtmlForm duration-200 ease-in-out peer-checked:translate-x-full dark:bg-neutral-400 dark:peer-checked:bg-white"></span>
    </label>
    <label htmlFor="pricing-switch" className="relative text-sm text-gray-800 dark:text-neutral-200">
      Annually
  ...
  <div className="mt-12 grid sm:grid-cols-2 lg:grid-cols-4 gap-6 lg:items-center">
    <div className="flex flex-col border border-gray-200 text-center rounded-xl p-8 dark:border-neutral-800">
      ...
      <p className="mt-2 text-sm text-gray-500 dark:text-neutral-500">htmlForever free</p>
    ...
    <div className="flex flex-col border-2 border-blue-600 text-center shadow-xl rounded-xl p-8 dark:border-blue-700">
      ...
      <p className="mt-2 text-sm text-gray-500 dark:text-neutral-500">All the basics htmlFor starting a new business</p>
    ...
    <div className="flex flex-col border border-gray-200 text-center rounded-xl p-8 dark:border-neutral-800">
      ...
      <p className="mt-2 text-sm text-gray-500 dark:text-neutral-500">Everything you need htmlFor a growing business</p>
    ...
    <div className="flex flex-col border border-gray-200 text-center rounded-xl p-8 dark:border-neutral-800">
      ...
      <p className="mt-2 text-sm text-gray-500 dark:text-neutral-500">Advanced features htmlFor scaling your business</p>
